...
func _ready():
	...
	light_win_sound.stream = load("res://assets/audio/win/LightWin.wav")  # Adjust the path
	...
	shadow_win_sound.stream = load("res://assets/audio/win/ShadowWin.wav")  # Adjust the path
	...
	light_combine_sound.stream = load("res://assets/audio/combine/LightCombine.wav")  # Adjust the path
	...
	shadow_combine_sound.stream = load("res://assets/audio/combine/ShadowCombine.wav")  # Adjust the path
	...
	cant_place_sound.stream = load("res://assets/audio/cant_place/CantPlaceHere.wav")  # Adjust the path
